...
public class Program {
    ...
    private static void showMenu(Zoo animals, Scanner input) {
        ...
        System.out.println("3. Просмотреть информацию о каком животном? ");
        System.out.println("4. Демонстрировать животное звук? ");
        System.out.println("5. Просмотреть информацию о всех животных в зоопарке? ");
        System.out.println("6. Всем животным в зоопарке издать звук?");
    ...
    private static void removeAnimal(Zoo animal, Scanner input) {
        animal.showAllAnimal();
        System.out.printf("%d) Назад\n", Zoo.allAnimal.size());
        System.out.print("Введите номер животного, которое удалить: ");
        int choice = input.nextInt();
        if (choice < Zoo.allAnimal.size()) {
            animal.removeAnimal(choice);
            System.out.println("Вы успешно удалили животное из списка!");
    ...
    private static void infoAnimal(Zoo animal, Scanner input) {
        animal.showAllAnimal();
        System.out.printf("%d) Назад\n", Zoo.allAnimal.size());
        System.out.print("Введите номер животного, которое хотите посмотреть: ");
        int choice = input.nextInt();
        if (choice < Zoo.allAnimal.size()) {
    ...
    private static void sayAnimal(Zoo animal, Scanner input) {
        animal.showAllAnimal();
        System.out.printf("%d) Назад\n", Zoo.allAnimal.size());
        System.out.print("Введите номер животного, кто должен издать звук: ");
        int choice = input.nextInt();
        if (choice < Zoo.allAnimal.size()) {
